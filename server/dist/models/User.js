...
var RegualrUserSchema = new mongoose_1.default.Schema({
    company_name: {
        type: String,
    },
    email: {
...
{ timestamps: true });
RegualrUserSchema.pre('save', function (next) {
...
RegualrUserSchema.methods.getSignedJWTToken = function () {
    return jsonwebtoken_1.default.sign({ id: this._id }, process.env.JWTSECRET, {
        expiresIn: process.env.JWT_EXPIRE,
    });
};
RegualrUserSchema.methods.matchPassword = function (enteredPassword) {
    return __awaiter(this, void 0, void 0, function () {
...
var RegualrUserModel = mongoose_1.default.model('RegualrUser', RegualrUserSchema);
exports.default = RegualrUserModel;
